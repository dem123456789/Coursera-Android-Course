...
public class ActivityLoaderActivity extends Activity {
	...
	static private final String title = "Load http://www.google.com with:";
	// For use with app chooser
	static private final String CHOOSER_TEXT = "Load " + URL + " with:";
	// TextView that displays user-entered text from ExplicitlyLoadedActivity runs
	private TextView mUserTextView;
	private static final int EXPLICIT_REQUEST = 0;
	private static final int IMPLICIT_REQUEST = 1;
	@Override
	...
	private void startExplicitActivation() {
		...
		startActivityForResult(explicitIntent, EXPLICIT_REQUEST);
